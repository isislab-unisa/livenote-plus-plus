...
function makeitlive(socket){
  ...
  socket.on("chat-message", (nickname, message, mode,color) => {
     socket.broadcast.emit("chat-message", nickname, message, mode,color);
  });
  ...
  socket.on("yt_start", (data) => {
    socket.broadcast.emit("ytstarting", data);
  });
  socket.on("yt_stop", (data) => {
    socket.broadcast.emit("ytstopping", data);
  });
  ...
  socket.on("ended_presentation", (data) => {
    socket.broadcast.emit("presentation_ending", data);
  });
